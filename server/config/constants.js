...
export const SEQUENCE_STATUS = {
  ...
  'PAUSED_SUB_FAILED': 'PAUSED_SUB_FAILED',
  'ARCHIVED': 'ARCHIVED'
};
...
export const SEQUENCE_STEP_TYPES = {
  ...
  MARK_CONTACT_COMPLETED: 'MARK_CONTACT_COMPLETED',
  PUSH_TO_SUB_SEQUENCE: 'PUSH_TO_SUB_SEQUENCE'
};
...
export const SEQUENCE_STEP_CONDITION_TYPES = {
  EMAIL_OPENED: 'EMAIL_OPENED',
  EMAIL_CLICKED: 'EMAIL_CLICKED',
  SPECIFIC_LINK_CLICKED: 'SPECIFIC_LINK_CLICKED',
  EMAIL_REPLIED: 'EMAIL_REPLIED',
  LINKEDIN_CONNECTION_ACCEPTED: 'LINKEDIN_CONNECTION_ACCEPTED'
};

export const SEQUENCE_STEP_BRANCH_WINNING_METRICS = {
  OPEN_RATE: 'OPEN_RATE',
