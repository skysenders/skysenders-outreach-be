          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background:{{background_color}}; border:1px solid {{border_color}}; border-radius:12px; padding:32px;">
            <tr>
              <td>
                ...
                <a href="{{product_url}}/workspace/join?token={{token}}&workspace={{workspace_name}}" style="display:inline-block; background:{{primary_color}}; color:#ffffff; text-decoration:none; padding:12px 20px; border-radius:8px; font-size:15px; font-weight:600;">
                  Accept invite
                </a>
                ...
                <p style="margin:16px 0 0; font-size:13px; line-height:20px; color:{{text_color}};">
                  ...
                  <br />
                  <a href="{{product_url}}/workspace/join?token={{token}}&workspace={{workspace_name}}" style="color:{{primary_color}};">
                    {{product_url}}/workspace/join?token={{token}}&workspace={{workspace_name}}
                  </a>
                </p>
