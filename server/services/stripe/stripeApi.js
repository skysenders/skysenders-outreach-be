import { STRIPE_PAY_KEY } from '../../config/constants';
 ...
 */
export const createSubscription = async(subscriptionInput) => {
 ...
 * @returns {String} it returns subscription details
 */
export const createSubscriptionItem = async(id, subscriptionInput) => {
 ...
 *  @returns {String} it returns subscription details
 */
export const deleteSubscriptionDiscount = async(subId) => {
 ...
 *  @returns {String} it returns subscription details
 */
export const updateSubscriptionItemCount = async(subItemId, userCount) => {
 ...
 *  @returns {String} it returns subscription details
 */
export const updateSubscriptionItem = async(subItemId, data) => {
 ...
 */
export const addSubscriptionDiscount = async(customerId, coupon) => {
 ...
 *  @returns {String} it returns subscription details
 */
export const getSubscriptionWithExpandInvoice = async(subId) => {
 ...
 *  @returns {String} it returns subscription details
 */
export const sendManualInvoice = async(invoiceId) => {
 ...
 */
export const getDefaultPaymentMethod = async(customerId) => {
...
export const saveBusinessDetails = async(customerId, address) => {
  return await stripe.customers.update(customerId, { address });
};

export const saveBusinessEmailName = async(customerId, name, email) => {
  return await stripe.customers.update(customerId, { name, email });
};

export const saveCustomerTaxDetails = async(customerId, taxDetails) => {
  return await stripe.customers.createTaxId(customerId, taxDetails);
};

export const deleteCustomerTaxDetails = async(customerId, taxId) => {
  return await stripe.customers.deleteTaxId(customerId, taxId);
};

export const getCustomerTaxDetails = async(customerId) => {
  return await stripe.customers.listTaxIds(customerId);
};

export const updateCustomerTaxDetails = async(customerId, taxDetails) => {
  // first fetch all the existing tax IDs of customer
  const existingTaxIds = await getCustomerTaxDetails(customerId);
  // delete all existing tax IDs
  for (const taxId of existingTaxIds.data) {
    await deleteCustomerTaxDetails(customerId, taxId.id);
  }
  // then create new tax IDs
  return await saveCustomerTaxDetails(customerId, taxDetails);
};

export const fetchPaymentIntentById = async(paymentIntentId) => {
  return await stripe.paymentIntents.retrieve(paymentIntentId);
};
export const fetchPaymentMethodById = async(paymentMethodId) => {
